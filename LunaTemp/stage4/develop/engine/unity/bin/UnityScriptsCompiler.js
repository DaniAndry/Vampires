...
if ( TRACE ) { TRACE( "Doctor.DoctorState.DoctorMoveState#Enter", this ); }
                ...
                if (this._firstEnter && this._route != null && this._route.length > 0) {
                    ...
                    this._firstEnter = false; // Сбрасываем флаг после первого входа
                ...
                if (this._route != null) {
                    ...
                    if (UnityEngine.Vector2.FromVector3(this.transform.position.$clone()).sub( UnityEngine.Vector2.FromVector3(targetPosition) ).length() < this._reachDistance) {
                        ...
                        if (this._currentWaypointIndex >= this._route.length && UnityEngine.MonoBehaviour.op_Equality(this.Target, null)) {
                            this._route = null;
                            this.enabled = false;
                            this._firstEnter = true; // Сбрасываем флаг для следующего использования состояния
                        }
                    }
                }
            },
...
if ( TRACE ) { TRACE( "Doctor.DoctorTransition.DoctorHealRunTransition#Update", this ); }
                ...
                if (this.Doctor.IsBusy && this.Target.OnPlace) {
                    this.Invoke("Complete", 0.4);
                }
            },
...
if ( TRACE ) { TRACE( "Doctor.DoctorTransition.DoctorMoveTransition#Update", this ); }
                ...
                if (UnityEngine.MonoBehaviour.op_Inequality(this.Target, null) && !this.Target.IsRun) {
...
if ( TRACE ) { TRACE( "Vampire.VampireTransitions.MoveTransition#Update", this ); }
    ...
    /*Doctor.DoctorTransition.DoctorHealRunTransition start.*/
    $m("Doctor.DoctorTransition.DoctorHealRunTransition", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Complete","t":8,"sn":"Complete","rt":$n[0].Void},{"ov":true,"a":2,"n":"Enable","t":8,"sn":"Enable","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void}]}; }, $n);
    /*Doctor.DoctorTransition.DoctorHealRunTransition end.*/
    ...
    /*Doctor.DoctorState.CharacterType start.*/
    $m("Doctor.DoctorState.CharacterType", function () { return {"att":257,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Doctor","is":true,"t":4,"rt":$n[9].CharacterType,"sn":"Doctor","box":function ($v) { return Bridge.box($v, Doctor.DoctorState.CharacterType, System.Enum.toStringFn(Doctor.DoctorState.CharacterType));}},{"a":2,"n":"Vampire","is":true,"t":4,"rt":$n[9].CharacterType,"sn":"Vampire","box":function ($v) { return Bridge.box($v, Doctor.DoctorState.CharacterType, System.Enum.toStringFn(Doctor.DoctorState.CharacterType));}}]}; }, $n);
    /*Doctor.DoctorState.CharacterType end.*/
